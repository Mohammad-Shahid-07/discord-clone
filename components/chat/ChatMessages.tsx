...
const ChatMessages = ({
  ...
  console.log(data, status, hasNextPage, isFetchingNextPage);
  ...
  return (
    <div
      ref={chatRef}
      className="flex-1 h-full flex flex-col py-4 overflow-y-auto"
    >
      ...
      <div className="flex h-full flex-col-reverse mt-auto">
          ...
          <Fragment key={i}>
            {group.messages.map((message: MessageWithMemberWithProfile) => (
              <ChatItem
                ...
                memberId={JSON.stringify(message.memberId)}
